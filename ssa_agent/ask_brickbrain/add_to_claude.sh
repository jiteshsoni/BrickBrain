...
if command -v claude &> /dev/null; then
    ...
    echo ""
    echo "💡 Alternative GitHub installation (if repo is public):"
    echo "claude mcp add databricks-mcp-github --scope local -- \\"
    echo "  uvx --from git+ssh://git@github.com/databricks-solutions/brickbrain-mcp.git brickbrain-mcp \\"
    echo "  --databricks-host \"$DATABRICKS_HOST\" \\"
